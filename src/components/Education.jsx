  ...
  return (
    <section id="certifications" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 py-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Certifications Grid - With Zigzag Row Reversal on Large Screens */}
        <motion.div
          initial="hidden"
          whileInView="visible"
          ...
          className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 lg:[&_.reverse-row]:direction-rtl"
        >
          {certifications.map((cert, index) => {
            // Reverse every 2nd row in the 3-column layout
            // Row 1 (indices 0,1,2) → normal
            // Row 2 (indices 3,4,5) → reversed
            // Row 3 (indices 6,7,8) → normal, etc.
            const isReverseRow = Math.floor(index / 3) % 2 === 1;
            ...
            return (
              <motion.div
                ...
                className={`relative group ${isReverseRow ? 'reverse-row' : ''}`}
              >
                {/* Hover Glow */}
                ...
                {/* Card - Force content to remain left-aligned */}
                <div
                  className={`relative direction-ltr text-left backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 ${
        ...
        >
          ...
          >
            <div className="text-2xl font-bold text-cyan-400 mb-2">7</div>
